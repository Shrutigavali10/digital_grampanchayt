...
if(isset($_POST['username_us'])){
    ...
    $password = $_POST['password_us'];  
        ...
        $sql = "select *from user where house_no = '$username' and phone = '$password'";  
...
<script src="js/jquery-1.11.0.min.js"></script>
  ...
  <script>
    function validateLogin() {
      ...
      const username = document.getElementById("username_us").value;
      const password = document.getElementById("password_us").value;
...
<div class="container">
  ...
  <div class="container1">
    <form class="login-form" action="user.php" method="post" onsubmit="return validateLogin()">
      <h1>User Login</h1>
      <label for="username_us">Username</label>
      <input type="text" id="username_us" name="username_us" required>
      <label for="password_us">Password</label>
      <input type="password" id="password_us" name="password_us" required>
