   ...
   <div>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
            <div class ="pname">
            <b> &nbsp; No. of Persons :- </b><?php echo $row['no_person'];?>
            </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
            <div class="page">
                 <b> &nbsp;  &nbsp;     Ward  :- </b><?php echo $row['ward_no'];?>
              </div>
            </td>
            <td>
            <div class="page">
                 <b> &nbsp;  &nbsp;     Water Connection :- </b><?php echo $row['water_conn'];?>
              </div>
            </td>
            <td>
            <div class="page">
                 <b> &nbsp;  &nbsp;     Area :- </b><?php echo $row['area'];?><strong> sqft</strong>
              </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
            <div class="page">
                 <b> &nbsp;  &nbsp;     No. Floor  :- </b><?php echo $row['floor'];?>
              </div>
            </td>
    ...
    <!-- <table>
        ...
        <tbody>
            <tr>
                <td>
                <div class="reports">
                   <a href="reportrequest.php"> <button  name ="allreport"> <b>Report Request </b> </button> </a> &nbsp;&nbsp;&nbsp;
                   <a href="reportrequest.php"> <button  name ="allreport"> <b> Complaint </b> </button> </a>
